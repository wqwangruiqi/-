$(document).ready(function () {
    ...
    function switchTheme(themeName) {
        if (themeName == 'classic') {
            $('#bs-css').attr('href', $('#themes').attr('address')+'bower_components/bootstrap/dist/css/bootstrap.min.css');
        } else {
            $('#bs-css').attr('href', $('#themes').attr('address')+'css/bootstrap-' + themeName + '.min.css');
        }
